...
1. **Principal** — the amount you start with or contribute regularly.
2. **Rate of return** — how much your investment grows each year, on average.
3. **Time** — how long the money stays invested.
...
Numbers on a page are one thing — watching your own scenario play out is another. Try our free [Compound Interest Calculator](/tools/compound-interest-calculator/) to see how an initial investment plus monthly contributions could grow over time at different rates of return.
